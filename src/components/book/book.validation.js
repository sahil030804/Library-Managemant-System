...
const addBookValidate = Joi.object({
  ...
  authors: Joi.string().trim().empty().required().messages({
    "string.empty": "Authors can't be empty",
    "any.required": "Authors must be required",
  }),
  ISBN: Joi.string().trim().empty().required().messages({
    "string.empty": "ISBN can't be empty",
    "any.required": "ISBN must be required",
  }),
  category: Joi.string().trim().empty().trim().required().messages({
  ...
  shelfNumber: Joi.string().trim().empty().required().messages({
